...
# The @app.route decorator is coming from Flask, and it is essentially treating a function
# as the initial execution point whenever an HTTP request is received to that particular endpoint
@app.route('/test')
def hello():
...
def create_user():
    data = request.get_json()  # get_json is a method that will return a dictionary -
    # - representing the request body JSON
...
# USE POSTMAN to view the JSON data
