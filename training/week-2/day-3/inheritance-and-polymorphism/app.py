...
class Dog(Animal):  # the Dog class inherits from Animal
    ...
    def __init__(self, name, color, number_of_eyes):
        ...
        super().__init__(color, number_of_eyes)  # This will call the __init__ method in the parent class and
        # pass in the color argument
        self.name = name
...
d1.play_game()  # Fido is playing fetch!
d2.play_game()  # Sparky is playing fetch!
print()

d1.make_noise()  # Fido says bark!
d2.make_noise()  # Sparky says bark!
print()
