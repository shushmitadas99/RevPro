...
# A dictionary is a set of key-value pair, where Keys are unique and immutable

# 1st way of populating key-value pairs
person_1 = {}  # pycharm shows sugesstions for creating dictionary in 2nd way
...
for k in person_1:
    print(f"{k}: {person_1[k]}")  # printing key-value pair
print()
