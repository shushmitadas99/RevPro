# Tuples are immutable (cannot change object state)
# Therefore, we cannot change elements isnide a tuple to something else
# Tuple needs to initialized (assigned values) when being created
...
my_tuple2 = (1, 2, 2, 1, 3, 3, 3, 3, 4, 3, 5, 10)

# .count() example
# Get the # of occurrences of int 3
three_count = my_tuple2.count(3)
print(f"my_tuple2 has {three_count} 3's")

# .index() example
# return the index of the first occurrence of a particular value
print(my_tuple2.index(5))  # index 10
print()

# We want to create a tuple with a single element
my_tuple3 = (50,)  # if you want to create a tuple with only 1 element, put a comma at the end of the element
